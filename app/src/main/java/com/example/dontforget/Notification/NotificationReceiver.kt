...
class NotificationReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, notificationIntent: Intent) {
        ...
        var notificationDataList =
            notificationIntent.getParcelableArrayListExtra<NotificationData>("notificationDataList")
        ...
        for (data in notificationDataList!!) {
            val Dday = DayCalculation().calculationDday(
                data.scheduleTime,
            ...
            if (Dday == null || Dday < 0L) {
                ...
                val nb: NotificationCompat.Builder =
                    notificationHelper.getChannelNotification(data.title!!, message)
